...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is NewsList_Category
                   DESC

  s.homepage     = "https://github.com/ModuleLovePlay/NewsList_Category"
  ...
  s.source       = { :git => "https://github.com/ModuleLovePlay/NewsList_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "NewsList_Category/NewsList_Category/**/*.{h,m}"
